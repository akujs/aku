...
export class PGLiteDatabase extends BaseClass implements Database {
	...
	constructor(config: PGLiteDatabaseConfig = {}) {
		super();
...
export function pgliteDatabase(config: PGLiteDatabaseConfig = {}): Database {
	return new PGLiteDatabase(config);
}
