...
describe(formatUsageToken, () => {
	test.each([
		...
		[
			1,
			"file",
			{ type: "string", positional: true, required: true } as const,
			"<file>",
			"<file>",
			"required",
		],
		...
		[
			3,
			"file",
			{ type: "string", positional: true, default: "foo" } as const,
			"[file]",
			"[file]",
		...
		[
			4,
			"count",
			{ type: "number", positional: true, required: true } as const,
			"<count>",
			"<count>",
			"number, required",
		],
		[
			5,
			"count",
			{ type: "number", positional: true } as const,
			"[count]",
			"[count]",
			"number, optional",
		],
		[
			6,
			"count",
			{ type: "number", positional: true, default: 8080 } as const,
			"[count]",
			"[count]",
		...
		[
			7,
			"file",
			{ type: "string", positional: true, array: true, required: true } as const,
			"<file> [file...]",
			"<file>",
			"required, repeatable",
		],
		[
			8,
			"file",
			{ type: "string", positional: true, array: true } as const,
			"[file...]",
			"[file]",
			"optional, repeatable",
		],
		[
			9,
			"file",
			{ type: "string", positional: true, array: true, default: ["a", "b"] } as const,
			"[file...]",
			"[file]",
			'optional, default: "a", "b", repeatable',
		],
		// Positional number array
		[
			10,
			"count",
			{ type: "number", positional: true, array: true, required: true } as const,
			"<count> [count...]",
			"<count>",
			"number, required, repeatable",
		],
		[
			11,
			"count",
			{ type: "number", positional: true, array: true } as const,
			"[count...]",
			"[count]",
			"number, optional, repeatable",
		],
		[
			12,
			"count",
			{ type: "number", positional: true, array: true, default: [1, 2] } as const,
			"[count...]",
			"[count]",
			"number, optional, default: 1, 2, repeatable",
		],
		// Named string
		[
			13,
		...
		[
			15,
			"file",
			{ type: "string", default: "foo" } as const,
			null,
			"--file=<value>",
			'optional, default: "foo"',
		],
		...
		[
			18,
			"count",
			{ type: "number", default: 8080 } as const,
			null,
			"--count=<value>",
			"number, optional, default: 8080",
		],
		...
		[
			19,
			"file",
			{ type: "string", array: true, required: true } as const,
			"--file=<value>",
			"--file=<value>",
			"required, repeatable",
		],
		[
			20,
			"file",
			{ type: "string", array: true } as const,
			null,
			"--file=<value>",
			"optional, repeatable",
		],
		[
			21,
			"file",
			{ type: "string", array: true, default: ["a", "b"] } as const,
			null,
			"--file=<value>",
			'optional, default: "a", "b", repeatable',
		],
		...
		[
			22,
			"count",
			{ type: "number", array: true, required: true } as const,
			"--count=<value>",
			"--count=<value>",
			"number, required, repeatable",
		],
		[
			23,
			"count",
			{ type: "number", array: true } as const,
			null,
			"--count=<value>",
			"number, optional, repeatable",
		],
		[
			24,
			"count",
			{ type: "number", array: true, default: [1, 2] } as const,
			null,
			"--count=<value>",
			"number, optional, default: 1, 2, repeatable",
		],
